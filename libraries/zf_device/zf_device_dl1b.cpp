...
*                   ------------------------------------
*                   模块管脚            单片机管脚
*                   SCL                 查看 zf_device_dl1b.hpp 中 DL1B_SCL_PIN  宏定义
*                   SDA                 查看 zf_device_dl1b.hpp 中 DL1B_SDA_PIN  宏定义
*                   XS                  查看 zf_device_dl1b.hpp 中 DL1B_XS_PIN  宏定义
*                   VCC                 5V 电源
*                   GND                 电源地
*                   ------------------------------------
*                   ------------------------------------
...
uint8 dl1b_init (void)
{
    ...
    do
    {
        ...
        memcpy(&data_buffer[2], const_cast<uint8 *>(dl1b_config_file), sizeof(dl1b_config_file));
